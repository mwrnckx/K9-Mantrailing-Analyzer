Public Class frmEditCategoryPoints
    ...
    Private Sub frmEditCategoryPoints_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        numSpeed.Value = CDec(_categoryInfo.PointsPerTempoMax)
        ...
        numCorridor.value = _categoryInfo.ToleratedCorridor_m
    End Sub

    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        _categoryInfo.PointsForFindMax = CInt(numFind.Value)
        _categoryInfo.PointsPerTempoMax = CDbl(numSpeed.Value)
        ...
        _categoryInfo.ToleratedCorridor_m = CInt(numCorridor.Value)
